 ...
 * exactly the failure the design review caught: `approval/minimal` quoted a
 * compile error it had never seen, and an adversary who ran `tsc` found the
 * code did not build at all.
 *
 ...
 *
 * This is hermetic: it reads files from disk and touches no network.
 */
...
/** Compile one fixture and return its diagnostics, sorted by line. */
